...
### ✅ Полностью реализовано (обязательные и числовые поля):
...
### ⚠️ Частично реализовано (необязательные dropdown):
- Единица измерения (searchable dropdown) — TODO
- Страна (searchable dropdown) — TODO
- Код налога (searchable dropdown) — TODO

*Примечание: Semantic UI searchable dropdown требуют дополнительной доработки для надежного выбора значений*
